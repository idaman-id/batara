...
var ValidationError_1 = __importDefault(require("../errors/ValidationError"));
...
var Validation = /** @class */ (function (_super) {
    ...
    Validation.prototype.handle = function (req, res, next) {
        ...
        if (!errors.isEmpty()) {
            ...
            return next(new ValidationError_1.default("invalid data" /* INVALID_DATA */, formatedErrors));
        }
        return next();
    };
    ...
    Validation.translateErrors = function (req, errors) {
        errors.forEach(function (error) {
             ...
             */
            var customMessages = lodash_1.merge(req._language.setting_messages, req._language.messages);
            ...
            if (customMessages.hasOwnProperty(locale + "." + key)) {
                 ...
                 */
                var customAttributes = lodash_1.merge(req._language.setting_attributes, req._language.attributes);
